  ...
  return (
    <div style={{height:"300px"}} className='container mt-5 w-100'>
        <div className="footer-content d-flex justify-content-between">
           ...
           <h5 style={{height:'30px'}} className='d-flex '> <i style={{height:"25px"}} className="fa-solid fa-download fa-beat me-2"></i>Media Player</h5>
           <p style={{textAlign:"justify"}}>Designed and built with all the love in the world by the Bootstrap team with the help oof our contributors</p>
